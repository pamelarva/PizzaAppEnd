...
class activity_register : AppCompatActivity() {
    ...
    val btnRegister: TextView = findViewById(R.id.buttonRegisterAccount)
    ...
    btnRegister.setOnClickListener {
        ...
        if (data == ""){
            ...
            val intentLogin = Intent(this@activity_register,
                LoginActivity::class.java)
            startActivity(intentLogin)
        }else {
            Toast.makeText(this@activity_register, "Register failed." +
